...
app.use(function (req, res, next) {
    res.header("Access-Control-Allow-Origin", "http://localhost:4200", "192.168.4.182:3000", "192.168.4.182:4200", "http://localhost:3000");
...
let authAdmin = (req, res, next) => {
    permitId = "606e1313b2cf7629f8fc9648"
...
function ffm(fileName) {
    ...
    shell.exec('C:/Users/DEVRAJSINH/Desktop/WatchIsta/video-sharing-platform-phase2/backend/images/create-vod-hls.sh ' + 'C:/Users/DEVRAJSINH/Desktop/WatchIsta/video-sharing-platform-phase2/backend'+ fileName)
    // C:/Users/DEVRAJSINH/Desktop/WatchIsta/video-sharing-platform-phase2/backend/images
}
...
app.get('/admin/dashboard', authAdmin,(req, res) => {
    ...
    VideoUpload.aggregate(
        ...
        genre.push(data);
        console.log("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", genre)
...
app.post('/forgot-password', (req, res) => {
    ...
    var transporter = nodemailer.createTransport({
        service: 'gmail',
        auth: {
            user: 'devrajsinh.zala@volansys.com',
            pass: 'Devraj@1911'
        }
    });

    var mailOptions = {
        from: 'devrajsinh.zala@volansys.com',
        to: email,
        subject: 'Sending Email from WatchIsta',
        text: 'Your OTP for changing your Watchista password: ' + otp
    };
